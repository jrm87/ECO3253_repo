...
Reminder: Today is deadline for submission

1. Clarifications about project
1. Causal effects of neighborhoods
1. Regression Analysis (work in couples for 15 mins)

## Clarifications for project

1. No need to submit anything. I will use time stamps for your work. Remember you should use the **project1** tab

2. When you create the Quarto/RMarkdown file, **do not change anything besides title and author** between the `---` lines (this is called YAML code).
...
Check the section on correlation
