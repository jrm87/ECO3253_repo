...
For this question, many covariates have been provided to you in the `atlas.rds` file, which are described in the Table under the Data Description section (Section \@ref(description)).  
