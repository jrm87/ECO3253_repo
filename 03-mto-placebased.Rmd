# Policies to Increase Upward Mobility {#mto-placebased}
...
knitr::include_graphics("../../images/mto_below13.png")
```
...
```{r , echo=FALSE, out.width = '90%'}
knitr::include_graphics("../../images/mto_below13-2.png")
```
...
```{r , echo=FALSE, out.width = '90%'}
knitr::include_graphics("../../images/price_opp_seattle.png")
```
